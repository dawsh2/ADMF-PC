#!/usr/bin/env python3
"""
Analyze RSI tuned strategy by identifying complete trade cycles.
...
def analyze_rsi_tuned_trades(workspace_path, data_path):
    ...
    print('ANALYZING RSI TUNED COMPLETE TRADE CYCLES')
    print('=' * 60)
...
if __name__ == "__main__":
    ...
    results = analyze_rsi_tuned_trades(workspace_path, data_path)
