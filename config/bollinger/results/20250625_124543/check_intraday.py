...
# Load trace
trace = pd.read_parquet("traces/signals/bollinger_bands/SPY_5m_strategy_0.parquet")
...
exit_percentage = (eod_signals["val"] == 0).mean() * 100
...
for i in range(len(unique_dates) - 1):
    ...
    if len(day1_signals) > 0:
        ...
        if len(day2_signals) > 0:
            ...
            # Check if position carried overnight
            if last_signal["val"] \!= 0 and first_signal["val"] == last_signal["val"]:
...
if exit_percentage > 95:
    ...
    print("⚠️  NOT WORKING: Many positions remain open at market close")
print("=" * 60)
