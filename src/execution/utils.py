"""
Execution utilities for financial calculations.

This module contains decimal operations and other utilities specific to
trading execution, ensuring all financial calculations use Decimal throughout
the system.
"""
