...
# Note: The class-based implementation has been commented out as it uses undefined Rule classes
# and indicator classes that don't exist in the current codebase.
# The pure function implementation below is the canonical version.
...
@strategy(
    ...
    feature_discovery=lambda params: [FeatureSpec('sma', {'period': params.get('sma_period', 20)}), FeatureSpec('adx', {'period': params.get('adx_period', 20)}), FeatureSpec('atr', {})]  # Topology builder infers parameters from strategy logic
)
