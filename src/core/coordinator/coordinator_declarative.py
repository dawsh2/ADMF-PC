...
from .sequencer_declarative import DeclarativeSequencer
from ..components.discovery import discover_components

logger = logging.getLogger(__name__)


class DeclarativeWorkflowManager:
    """
    ...
    def __init__(self, 
        ...
        self.sequencer = sequencer or DeclarativeSequencer(self.topology_builder)
        ...
        logger.info(f"DeclarativeWorkflowManager {self.coordinator_id} initialized with "
    ...
    def _load_workflow_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        patterns = {}
        pattern_dir = Path(__file__).parent / 'patterns' / 'workflows'
