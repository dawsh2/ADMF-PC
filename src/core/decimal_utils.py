"""
Decimal utilities for consistent financial calculations

This module ensures all financial calculations use Decimal throughout
the system, eliminating float/Decimal mixing issues.
"""
...
class DecimalEncoder:
    ...
    @staticmethod
    def decode(obj):
        """Decode string back to Decimal if it looks like a number"""
