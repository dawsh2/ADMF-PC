...
class FeatureHubComponent:
    ...
    def __init__(self, symbols: Optional[List[str]] = None):
        ...
        from ...strategy.features.hub import FeatureHub
...
class ContainerFactory:
    ...
    def _create_component(self, component_name: str, config: Optional[Dict[str, Any]] = None) -> Optional[Any]:
        ...
        try:
            ...
            if component_name == 'data_streamer':
                ...
                return self._create_feature_hub_component(config)
            else:
    ...
    def _create_feature_hub_component(self, config: Dict[str, Any]) -> 'FeatureHubComponent':
        """Create FeatureHubComponent instance."""
