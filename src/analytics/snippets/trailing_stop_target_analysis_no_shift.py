...
# Modified to ensure entry bar is included in stop/target checks
...
if results:
    ...
    print("\n4. ENTRY BAR INCLUSION:")
    print("   - This analysis includes the entry bar when checking for stops/targets")
    print("   - This ensures immediate stops/targets on volatile entry bars are captured")
