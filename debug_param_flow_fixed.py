#!/usr/bin/env python3
"""Debug parameter flow from config to metadata.json - with component discovery"""
...
# IMPORTANT: Discover components first!
...
for module in modules:
    try:
        count = discover_components_in_module(module)
...
bollinger_info = registry.get_component('bollinger_bands')
if bollinger_info:
    print(f"\n✅ bollinger_bands registered successfully")
    print(f"  Parameter space: {bollinger_info.metadata.get('parameter_space', {})}")
else:
